...
with tab1:
    ...
    # Бұл виджеттер бір-біріне әсер етеді, сондықтан форманың СЫРТЫНДА болуы керек
    ...
    # "Басқа пән" логикасы да сыртта болуы керек
    other_subject = ""
    ...
    # Бұл жерде тек баға, студент және комментарий қалады
    with st.form("grade_form"):
        
        st.subheader("2. Бағалау мәліметтері")

        # Студентті таңдау (форма ішінде)
    ...
    if submitted:
        # final_subject форманың сыртында анықталған 'selected_subject' айнымалысын пайдаланады
        ...
        elif selected_student == "Студентті таңдаңыз...": # selected_student формадан келеді

...
if selected_tab == "Хабарландырулар":
    ...
    st.warning(
        "🔥 **Маңызды (Дедлайн):** 'Физика' пәнінен СӨЖ-1 жұмысын осы жұмаға (28.11.2025) дейін тапсыру керек!", 
        icon="🔥"
    )
    
    st.info(
        "ℹ️ **Жалпы хабарлама:** Ертең, 26.11.2025 (сәрсенбі), сабақтар 1 сағатқа қысқартылады. Себебі - оқытушылар жиналысы.", 
        icon="ℹ️"
    )
    ...
    st.error(
        "❌ **Сабақ болмайды:** 'Дене тәрбиесі' пәнінің оқытушысы ауырып қалуына байланысты бүгін (25.11.2025) соңғы сабақ болмайды.", 
        icon="❌"
    )
